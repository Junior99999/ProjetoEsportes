...
module.exports = {
    ...
    async add(req,res){
        ...
        await Produto.create({ nome, valor, tipo}).then(
            (produto) => {
                ...
                req.flash('msg', "Problemas ao adicionar o Porduto.")
                res.redirect('/admin/produto/add');
        });
    },
    ...
    async edit(req,res){
        ...
        produto.save().then(
            ...
            (err) =>{
                req.flash('msg','Problema ao alterar produto');
                res.render('admin/produto/edit.ejs',{'Produto':produto, 'msg': req.flash('msg')})
            }
        );
    },
    async del(req,res){
        ...
        await Produto.destroy({
            ...
            (produto) => {
                req.flash('msg','Produto foi editado com sucesso!');
                res.redirect('/admin/produto/')
            },
            (err) => {
                req.flash('msg','Problema ao deletar produto');
                res.redirect('/admin/produto/')
            }
